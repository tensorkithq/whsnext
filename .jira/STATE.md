...
|------|--------|------|---------|
| 2026-09-02-escalation-engine-pot-grows | researching | Server-owned absurdity ladder: `absurdity_level` +1 per canonized vote lock, L0–L5 fragments into script + video prompts, votes pick escalation form ([#8](https://github.com/tensorkithq/whn/issues/8)) | — |
